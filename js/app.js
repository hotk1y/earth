(() => {
   ...
   class MousePRLX {
      ...
      paralaxMouseInit(paralaxMouse) {
         paralaxMouse.forEach((el => {
            ...
            const paramСoefficientX = el.dataset.prlxCx ? +el.dataset.prlxCx : 280;
            const paramСoefficientY = el.dataset.prlxCy ? +el.dataset.prlxCy : 280;
            const directionX = el.hasAttribute("data-prlx-dxr") ? -1 : 1;
            const directionY = el.hasAttribute("data-prlx-dyr") ? -1 : 1;
            const paramAnimation = el.dataset.prlxA ? +el.dataset.prlxA : 35;
   ...
   function initSliders() {
      if (document.querySelector(".services__slider")) new swiper_core_Swiper(".services__slider", {
         modules: [Navigation],
         observer: true,
         observeParents: true,
         slidesPerView: 1,
      ...
      if (document.querySelector(".company__slider")) new swiper_core_Swiper(".company__slider", {
         modules: [Navigation],
         observer: true,
         observeParents: true,
         slidesPerView: 3,
   ...
   da.init();
   const videoPlay = document.querySelector(".videoblock__play");
   const videoBlock = document.getElementById("my-video");
   const videoActive = () => {
      videoPlay.addEventListener("click", (() => {
         document.querySelector(".videoblock").classList.add("_play-video");
         setTimeout((() => {
            videoBlock.play();
         }), 500);
      }));
      videoBlock.addEventListener("ended", (() => {
         setTimeout((() => {
            document.querySelector(".videoblock").classList.remove("_play-video");
         }), 1e3);
      }));
   };
   videoActive();
